...
def extract_text_from_image(file_content: bytes) -> str:
    ...
    try:
        ...
        logger.warning("Image contains no extractable text.")
        return "[Image file - Please ensure invoice data is provided as text or PDF with selectable text.]"
...
def detect_file_type(filename: str, file_content: bytes) -> str:
    """Detect file type from filename and content. Returns: 'pdf', 'image', or 'text'."""
    ...
    if file_content[:4] == b'%PDF':
        ...
        return 'image'
    elif file_content[:2] in [b'\xff\xd8', b'GI']:
        return 'image'
